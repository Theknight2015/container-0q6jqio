...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0q6jqio.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0q6jqio.containers.anotherwebservice.com/
...
```
git clone git@github.com:Theknight2015/container-0q6jqio.git
cd container-0q6jqio
```
...
```
docker attach container-0q6jqio
```
